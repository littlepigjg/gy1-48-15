...
export const RADIATION = {
  ...
  CARGO_BASE_DPS: 0.3,
  CARGO_MIN_RATIO: 0.02,
  CARGO_LEAK_WARN_THRESHOLD: 0.3,
  CARGO_CONTAMINATION_GROWTH_RATE: 0.02,
  ENEMY_MUTATION_CHANCE: 0.02,
  ENEMY_DAMAGE_MULTIPLIER: 1.5,
  ENEMY_MUTATE_HEALTH_MULT: 1.5,
  ENEMY_MUTATE_DAMAGE_MULT: 1.3,
  ENEMY_MUTATE_SPEED_MULT: 1.2,
  ENEMY_MUTATE_GOLD_MULT: 1.5
};
